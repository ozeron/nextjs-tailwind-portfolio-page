    ...
    <section className="px-8">
      ...
      <div className="px-8 grid grid-cols-1 md:grid-cols-10">
        <div  className="col-span-3 mx-auto mb-5 text-left">
          ...
          <Typography variant="lead">
            <ClockIcon className="inline-block mr-1 h-5 w-5 text-yellow-800" /> 90 хв
          </Typography>
          <Typography variant="lead" className="pb-5">
            <BanknotesIcon className="inline-block mr-1 h-5 w-5 text-yellow-800" /> 4000 грн
          </Typography>
          <a href={SIGNUP_URL} target="_blank" rel="noopener noreferrer">
            <Button className="w-full md:w-32 bg-yellow-800" color="gray" size="sm">
              Записатися
            </Button>
          </a>
        </div>
        ...
        <div className="col-span-7 mx-auto mb-20 text-left">
          <Typography variant="paragraph" className="mb-5">
            За одну консультацію ми можемо з вами пропрацювати якісно <strong className="text-yellow-800">один кар'єрний запит</strong>. Спочатку ми проведемо короткий discovery-call, де обговоримо очікування та потреби. Я дам вам домашнє завдання (pre-work), яке потрібно зробити перед консультацією.
          </Typography>
          <Typography variant="paragraph" className="mb-5">
          ...
          <ul className="list-disc list-inside">
              ...
              <li className="mb-2 antialiased font-sans text-base font-light leading-relaxed text-inherit">
                  <strong className="text-yellow-800">Важливо:</strong> зробити pre-work перед консультацією, щоб заняття було ефективне.
              </li>
            </ul>
      ...
      <div className="px-8 grid grid-cols-1 md:grid-cols-10">
        ...
        <div  className="col-span-3 mx-auto mb-5 text-left">
          ...
          <Typography variant="lead">
            5 занять х <ClockIcon className="inline-block mr-1 h-5 w-5 text-yellow-800" /> 90 хв
          </Typography>
          <Typography variant="lead" className="pb-5">
            <BanknotesIcon className="inline-block mr-1 h-5 w-5 text-yellow-800" /> 20 000 грн
          </Typography>
          <a href={SIGNUP_URL} target="_blank" rel="noopener noreferrer">
            <Button className="w-full md:w-32 bg-yellow-800" color="gray" size="sm">
              Записатися
        ...
        <div className="col-span-7 mx-auto mb-20 text-left">
          ...
          <ul className="list-disc list-inside">
            ...
            <li className="mb-2 antialiased font-sans text-base font-light leading-relaxed text-inherit">
                <strong className="text-yellow-800">Важливо:</strong> робити pre-work перед консультаціями, щоб заняття були ефективні.
            </li>
          </ul>
        </div>
